...
export default function Footer() {
  return (
    <footer className="bg-gray-900/80 backdrop-blur-lg border-t border-gray-700/50 w-full pt-6">
      <div className="mx-auto w-full container p-4 py-6 lg:py-8">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 sm:justify-center sm:mt-0 gap-2">
            <a
              href="#"
              className="w-10 h-10 bg-gray-800/50 border border-gray-700/50 rounded-lg flex items-center justify-center text-gray-400 hover:bg-blue-600 hover:border-blue-600 hover:text-white transition-all duration-300"
            >
              <svg
                className="w-5 h-5"
                aria-hidden="true"
            ...
            <a
              href="#"
              className="w-10 h-10 bg-gray-800/50 border border-gray-700/50 rounded-lg flex items-center justify-center text-gray-400 hover:bg-indigo-600 hover:border-indigo-600 hover:text-white transition-all duration-300"
            >
              <svg
                className="w-5 h-5"
                aria-hidden="true"
            ...
            <a
              href="#"
              className="w-10 h-10 bg-gray-800/50 border border-gray-700/50 rounded-lg flex items-center justify-center text-gray-400 hover:bg-gray-800 hover:border-gray-600 hover:text-white transition-all duration-300"
            >
              <svg
                className="w-5 h-5"
                aria-hidden="true"
